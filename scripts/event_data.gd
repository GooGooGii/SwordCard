				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "逍遙蹲下盯著道士看了半天——這眉眼、這酒癮、這破葫蘆，他越看越覺得像他師父的某個老酒友。道士忽然睜眼笑了：『臭小子，老子終於等到你了。』他搶過葫蘆灌了一口，又把一段劍訣塞給逍遙。",
						},
					},
					{
						"id": "leave",
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "「你叫唐鈺對吧？」逍遙停下劍，「記住你今天這一招——這是我師父教我的時候，反過來教給我的東西。」唐鈺一愣，鄭重地點頭。逍遙笑了：『以後別再亂揮，那把劍配得上你。』",
						},
					},
					{
						"id": "lin_correct",
						"label": "（林月如）親自示範林家堡的起手式",
						"kind_hint": "reward",
						"requires": {"character": ["lin_yueru"]},
						"outcome": {
							"kind": "reward",
