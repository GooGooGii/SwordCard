...
const VARIANTS: Dictionary = {
	"spring": {
		...
		"character_flavors": {
			...
			"zhao_linger": "清泉的水氣撲來，靈兒不由自主地停下腳步。她把指尖浸入水中——不是試水溫，是在聽。水脈深處有一縷極淡的靈息，向她的血脈輕輕回應，像遠親之間認出了彼此。她收回手，掌心那點涼意久久不散：這眼泉有主人，而它並不介意她來過。",
		...
		"outcomes": {
			...
			"power": "泉聲入耳如磬，靈台一清。你閉目聆聽良久，招式的鋒芒在水聲中無形地凝練，變得更堅實，也更沉靜。"
		},
		# ── tree schema ────────────────────────────────────────────────
		# 分支樹已全面上線（EventRunner 走訪 + UI 呈現），全部事件皆有 tree；
		# 舊扁平 schema 僅作無 tree 時的 fallback 保險。設計見 docs/EVENT_BRANCHING.md。
		"tree": {
			"root": {
				...
				"choices": [
					...
					},
					{
						...
						"label": "以劍逼泉，強取泉靈精華",
						"kind_hint": "punish",
						"requires": {"character": ["li_xiaoyao", "lin_yueru"]},
						"outcome": {
							"kind": "punish",
							"effects": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "咒印落水的剎那，整眼泉像被踩了尾巴的活物猛地一縮。它認得你血脈裡的靈息——正因認得，那聲冰冷的呵斥才格外重，順著咒訣直灌心口。你咬牙收攝，硬是從翻湧的水心引出一縷精純靈韻。收訣退開，指尖發白——拿是拿到了，但水面再不映你的影子。以同源之靈行奪取之事，這筆債記得更深。",
						},
					},
					{
						"id": "siphon_spring_spirit_gu",
						"label": "放蠱入水，噬取泉靈精華",
						"kind_hint": "punish",
						...
						"outcome": {
							...
							"log": "蠱蟲離指沒入水心的剎那，整眼泉像被踩了尾巴的活物猛地一縮。冰冷的呵斥順著蠱線倒灌回你的指尖，你咬牙牽住，硬是讓蠱蟲銜回一縷精純靈韻。收蠱退開，指節發白——寨裡的老人說過，水裡的東西不能搶。拿是拿到了，但水面再不映你的影子。山野有靈，這筆債記下了。",
						},
					},
					{
						"id": "bandit_ambush",
					...
					"choices": [
						...
						},
						{
							...
							"outcome": {
								...
								"log": "你的手指剛按上兵刃，腳踝邊那絲流動便倏地退了。水面盪開一圈淺笑似的漣漪——泉靈識趣，你也識趣。彼此留了體面，你帶著一身警醒上岸，這份警醒會替你擋下一陣。",
							},
						},
					],
				},
	...
	"talisman_cache": {
		...
		"character_flavors": {
			...
			"zhao_linger": "靈兒以指尖輕觸匣面，符文的走向讓她一怔——那筆觸與靈族文字有幾分相似，卻像是被人生硬地翻譯過，溫柔已然磨損，只剩力量。她辨出了落款處一個殘缺的敬語：這是寫給後來人的。她輕聲把那個敬語念完，替那位不知名的修者，把磨損掉的溫柔補了回去。",
					...
					"choices": [
						...
						},
						{
							...
							"outcome": {
								...
								"log": "四個字在你指腹下化作符灰，簌簌散盡。匣蓋應聲而啟，靈光湧出，在你掌紋裡烙下一道術法的輪廓——陌生，卻意外貼合你的手。符灰散盡的剎那，指腹一陣刺痛：那道禁制臨散前，終究咬了你一口，這一口，往後都長在你身上。夜靜時，你偶爾會想起那句被你親手抹掉的囑咐。",
							},
						},
					],
				},
	...
	"shrine": {
		...
		"character_flavors": {
			...
			"zhao_linger": "石壁間的光讓靈兒想起了靈族聖地的模樣。她向光暈深深行禮，低聲念著感謝之語。走近了她才辨出來——這不是神蹟，是某位修者坐化前留下的一縷願念，乾淨、安靜，還守在原地護佑著過路的人。她把手輕輕覆上石壁，像替那位前人，接下了這句沒能說完的話。",
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "你不請自取，引那道殘光入體。前輩的遺意冷冷地掃過你的經脈——『不請而取者，自承其患。』那股力量留了下來，但某種你也說不清的東西，從此跟著你走。",
						},
					},
					{
						"id": "leave",
				...
				"choices": [
					{
						...
						"label": "抽刀挑鎖，硬撬開它",
						"kind_hint": "gamble",
						"requires": {"character": ["li_xiaoyao", "lin_yueru", "anu"]},
						"outcome": {
							"kind": "gamble",
							"gamble": {
								"win_chance": 0.5,
					...
					},
					{
						...
						"outcome": {
							...
							"log": "你把一縷靈力順著鏽鏈一寸寸灌進去，鏈環嗡然震顫，應聲崩開。箱蓋彈起的剎那，一縷陳年的暗香混著鐵鏽味撲面而來——箱裡的東西，和箱裡的毒針，在這一刻同時醒了。",
						},
					},
					{
						"id": "careful",
						...
						"outcome": {
							...
							"log": "你退開半步，用枯枝遠遠壓下鎖扣。「噗」的一聲輕響，毒針深深釘進枝身，木屑輕顫。箱中銅錢成串，還臥著一只油紙裹好的藥瓶——前主人收拾得很體面。",
						},
					},
					{
						"id": "observe_trap",
	...
	"ancestor_relic": {
		...
		"outcomes": {
			"power": "骨殖微微顫動，一縷殘存的意志悄然融入你的招式，殺伐之氣更甚從前。那是另一個人走了一輩子才走出來的鋒芒，此刻，傳到了你的手上。",
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "在苗疆，骨殖是神聖的，擅動先人之力是重罪。阿奴取出隨身的草藥與骨針，照寨中老巫醫的規矩在壇前一樣一樣擺開，低聲唱起安魂的古調。唱到尾音，壇上濃得壓住風的靈氣輕輕伏了下去，像被撫平的水面——先靈沒有怪她，反而把一縷溫熱的意念順著古調送進她的掌心：異鄉的禮，他認了。",
						},
					},
					{
						"id": "leave",
					...
					"choices": [
						{
							...
							"outcome": {
								...
								"log": "你跪下的剎那，骨殖中那縷意志傾身而出，沉沉壓進你的胸口——像接過一炷傳了百年的香火。熱意自心口散向四肢，有什麼從此長在你的招式裡。你向骨殖叩首：「前輩，接住了。」",
							},
						},
						{
	...
	"wandering_sage": {
		...
		"character_flavors": {
			...
			"zhao_linger": "老者打量她的眼神平靜而直接，不帶評判，卻也無遮無擋。靈兒端著茶盞回望過去——她看得出來，這位老人身上沒有妖氣、沒有殺意，只有一種燒了很多年、已經燒得極穩的火。粗茶苦而回甘，她忽然想：若有一天走到無路可走的地方，希望自己也能靜成這樣。",
		...
		"observe_text": "你不開口，只是靜靜看著老者。他煮茶的動作極慢，每一個步驟都精準到像是練過幾十年的招式——這位老者並非閒人，他的靜止是經過無數動作淬鍊出來的。他的目光偶爾抬起，掃過你身上的傷口、神色、兵器的位置——他看見的，比他說出來的多得多。",
		...
		"tree": {
			"root": {
				"prompt": "茶香先一步攔住了你——粗茶，火氣很足，混著松枝燒裂的味道。道旁石上，一位竹笠下白髮垂胸的老者守著一只小泥爐，看你走來只是抬眼，又低頭撥火，不發一語。那一眼很短，卻像把你連人帶一身功夫都稱過了。",
				"choices": [
					{
						"id": "seek_teaching",
						"label": "上前拱手，誠心求教",
					...
					},
					{
						...
						"outcome": {
							...
							"log": "你坐了一炷香，他添了三次水，誰都沒開口。起身告辭時，老者忽然頭也不抬地說：「你的手，會替你找到答案。」就這一句，卻在你往後每次出手時隱隱作響。",
						},
					},
					{
						"id": "observe_master",
			...
			"nodes": {
				...
				"node_recognize": {
					"prompt": "你盯著他煮茶的手——提壺、注水、收腕，每個動作都準得像練了幾十年的招式，半分不多，半分不少。這不是山野閒人，是把一身驚人的功夫，收進一壺粗茶裡的高人。",
					"choices": [
						{
							"id": "apprentice",
							"label": "撩衣下拜，拜一日之師",
	...
	"moonlit_pool": {
		...
		"character_flavors": {
			...
			"zhao_linger": "靈兒在潭邊蹲下，指尖還未觸到水面，潭心那輪月忽然漾了一下，像是認出了什麼。她怔住——這潭水底沉著的古老靈氣，與仙靈島水月宮的氣息隱隱同源，像一位遠親隔著水面向她問了聲好。她輕輕把手覆上水面，沒有攪動：「打擾了。」那輪水中月靜靜地亮著，比天上那輪，更像是在對她笑。",
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "心裡明明發毛，逍遙還是照外婆教的土法子來：三炷香、三個響頭，嘴裡念念有詞——「山神爺爺，路過借光，不拿不搶。」拜完睜眼，神龕腳邊竟滾出幾枚前人的香油錢，背上的涼意也散了。外婆的土法子，靈得很。",
						},
					},
					{
						"id": "leave",
					...
					"choices": [
						{
							...
							"outcome": {
								"kind": "neutral",
								"effects": [
									{"kind": "next_battle_buff", "effects": [{"kind": "block", "amount": 4}]},
								],
								"log": "你把符紙照原樣壓回香灰底下，貓著腰退出廟門，把半掩的門恢復成你來時的模樣。走出一里地你才回頭——廟簷安安靜靜。知道什麼東西住在裡面、而不去驚動它，這份清醒往後幾步路都護著你。",
							},
						},
						{
							"id": "ambush",
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "月如最討厭自己被心動，索性把那點心動折成價碼砸回去：「立契可以，條件我開——血只給一滴，貨先驗，事成兩清，互不相欠。」妖女怔了怔，笑出聲來：「林家堡的算盤，比刀還利。」一滴血，換一卷符、一袋金，銀貨兩訖。",
						},
					},
					{
						"id": "power_overwhelm",
					...
					"choices": [
						{
							...
							"outcome": {
								...
								"log": "你揮起兵刃劈向那條黑鏈。鏈環崩斷的剎那，妖女怔怔望著頸間的斷口，眼裡第一次有了人的光——來不及道謝，黑霧轟然崩塌，鏈子另一端的東西醒了。勝，她便乘著散開的霧自由遠去；敗，你們一起沉回霧底。",
							},
						},
						{
							"id": "fake_pact",
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "靈兒散著髮在戰場中央站定，安魂咒一句一句，輕得像替人掖被角。滿場低鳴一點一點靜下去，繃了千年的殺伐從土裡緩緩鬆開，化作一場極細的暖雨落在全隊肩頭。臨散前，某個亡魂把畢生僅有的一式，輕輕放進了她手裡。",
						},
					},
					{
						"id": "blade_communion",
	...
	"alchemy_furnace": {
		...
		"character_flavors": {
			...
			"zhao_linger": "靈兒站在爐前，指尖還未觸到爐壁便縮了回來——爐氣裡纏著一縷極淡的殘魂氣息，是煉丹的人自己留下的。她認得這種味道：把自己一點一點交出去的人，身上就是這種味道。她對著爐火合十，靜靜低了低頭。不知為何，她心口隱隱發悶，像是替那位素未謀面的煉丹人疼，又像是被什麼遙遠的、還沒到來的東西，輕輕碰了一下。",
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "阿奴對著丹爐擺擺手：「煉丹我不會，藥材我認得。」她閉眼逐縷分辨藥香，鼻尖一動——從灰堆邊揀出兩味苗疆才有的毒草，又挑走幾株沒被火氣燻壞的好藥，蹲在爐外按巫醫的老路子搗了一份藥。丹爐她一指都沒碰：「爐是他的，藥是山的。」",
						},
					},
					{
						"id": "leave",
			...
			"root": {
				...
				"choices": [
					...
					},
					{
						...
						"label": "橫兵直入，朝那目光闖去",
						"kind_hint": "battle",
						# 與 fox_repays / fox_vengeance 互斥：放過狐女的人不會對那雙金瞳動手；殺過狐的人走 fox_vengeance 尋仇線
						"requires": {"not_event_flag": ["fox_spared", "fox_slain"]},
						"outcome": {
							"kind": "battle",
							"battle": {
								"enemy_id": "fox_spirit",
							...
							"log": "你橫起手中兵器，不挑路，直直朝那道注視走過去。霧忽然向兩旁讓開——一隻金瞳狐影自霧心浮出，姿態慵懶，眼裡卻全是算計：敢闖進來的，不是膽子大，就是肉好吃。",
						},
					},
					{
						...
						"outcome": {
							...
							"battle": {
								...
								"victory_effects": [
									{"kind": "gain_relic_pool", "pool": "uncommon"},
									{"kind": "gold", "amount": 15},
									{"kind": "set_flag", "flag": "fox_slain", "value": false},
								],
								"defeat_effects": [
									{"kind": "damage", "amount": 12},
								],
							},
							"log": "那股殺氣從你踏進霧界起就綴在身後，此刻終於不再掩飾。霧心浮出一雙泣紅的金瞳——你在隱龍窟殺的那隻狐，牠的族人循著血債找上門了。「還我族親的命來。」這一戰躲不掉；勝了，血債就此劃清，牠們不會再來。",
						},
					},
					{
						"id": "fox_repays",
					...
					"choices": [
						...
						},
						{
							...
							"outcome": {
								...
								"log": "既然看清了它，先手就是你的。你繞到老樹背風的下方，足尖借力，第一擊直取那雙黃眼——獵人與獵物，今天換個位置坐坐。",
							},
						},
					],
				},
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "逍遙半信半疑地踏出「仙風雲體術」的起手，第三步還沒踩穩，整片石坪的符紋忽然逐圈亮起，順著他的步子替他把後半套走完了——那是連師父都還沒來得及教的部分。入定千年的古仙沒有現身，只借這座陣，替酒劍仙把這個弟子往前送了一程。逍遙收勢站定，怔了半晌，朝地面深深一揖：「多謝前輩。」",
						},
					},
					{
						"id": "power_resonance",
						...
						"outcome": {
							...
							"log": "你不跪不求，只把一身淬鍊到極處的殺意緩緩放出。符紋劇烈震顫，像是被喚醒的舊識——古仙的入定意念與你的鋒芒對撞、相認，臨去前替你那身淬鍊多年的殺意又添了一層厚度。",
						},
					},
					{
						"id": "leave",
	...
	"spirit_clan_ruins": {
		...
		"character_flavors": {
			...
			"lin_yueru": "月如打量著符文，試圖以走南闖北的江湖見聞加以比對，但沒有成功——這是她從未見過的文字體系。她想到了靈兒，心中對這個溫柔的靈族少女又多了幾分敬意：帶著這樣龐大而陌生的傳承，還能走得如此平靜，不是一件容易的事。",
					...
					"choices": [
						{
							...
							"outcome": {
								...
								"log": "你在石壁前靜坐一夜。隔日離開時，出手沉了幾分，殺意卻淡了幾分——原來放下，也是一種力量。",
							},
						},
						{
							"id": "pry_jade",
		...
		"tree": {
			"root": {
				...
				"choices": [
					...
					{
						"id": "waner_path",
						"label": "按著內襟上的血指方位走到壇前",
						"kind_hint": "reward",
						"requires": {"event_flag": "waner_clue"},
						"outcome": {
							"kind": "reward",
							"effects": [
								{"kind": "permanent_power", "amount": 1},
								{"kind": "heal", "amount": 8},
								{"kind": "set_flag", "flag": "waner_clue", "value": false},
							],
							"log": "你解開衣襟，對著心口那道血畫的方位——正是此壇。婉兒用盡最後一口氣指向的北方，你替她走到了。你在壇前立了很久，把她沒能說完的話、沒能討回的公道，一樁樁記進骨頭裡。血債的源頭就在眼前，胸中那股火反而靜了下來，燒得又穩又長。轉身時，你腳步比來時沉，也比來時穩。",
						},
					},
					{
						"id": "yao_guide",
						"label": "壇影裡，站著一個你認得的身影",
						"kind_hint": "reward",
						"requires": {"event_flag": "yao_freed"},
						"outcome": {
							"kind": "reward",
							"effects": [
								{"kind": "heal_party", "amount": 8},
								{"kind": "gain_relic_pool", "pool": "uncommon"},
								{"kind": "set_flag", "flag": "yao_freed", "value": false},
							],
							"log": "壇影深處，那張瓜子臉靜靜看著你——是你斬斷鎖鏈放走的妖女。她的腕上還留著淺淺的鏈痕：「拴我的鏈子，就是從這座壇上鑄出來的。」她引你繞開壇眼的邪視，臨別把一件小東西按進你掌心，「當日你斬的那一下，我記到今天。」說完身影散入夜色，這次，是她自己選的去處。",
						},
					},
					{
						"id": "gu_devour_evil",
					...
					"choices": [
						...
						},
						{
							...
							"outcome": {
								...
								"log": "你出手挑破中心符文。整個血環在一聲悶響中崩解——胸中某道舊習也隨之碎裂，乾淨得令人微微失重。",
							},
						},
					],
				},
	...
	"tavern_acquaintance": {
		...
		"tree": {
			"root": {
				...
				"choices": [
					...
					},
					{
						...
						"label": "敬老劍客一壺酒，求教劍術",
						"kind_hint": "mixed",
						"requires": {"min_gold": 10, "character": ["li_xiaoyao", "lin_yueru"]},
						"outcome": {
							"kind": "mixed",
							"effects": [
								{"kind": "gold", "amount": -10},
					...
					{
						"id": "zhao_tea",
						"label": "（趙靈兒）奉茶老劍客，靜聽往事",
						"kind_hint": "mixed",
						"requires": {"character": ["zhao_linger"], "min_gold": 10},
						"outcome": {
							"kind": "mixed",
							"effects": [
								{"kind": "gold", "amount": -10},
							...
							"log": "靈兒不飲烈酒，只替老劍客奉上一盞熱茶。老人怔了怔，把橫在桌邊的劍往內收了收，難得開了口——說的是他等的那個人，和一段走不完的江湖。靈兒靜靜聽完，忽然懂了自己某道術法裡一直差著的那口氣：原來不是力道，是捨得。",
						},
					},
					{
						"id": "anu_caravan",
						"label": "（阿奴）聽出商旅談的是苗疆商路",
						"kind_hint": "reward",
						"requires": {"character": ["anu"]},
						"outcome": {
							"kind": "reward",
							...
							"log": "阿奴壓低斗笠聽了半晌——那兩個商旅談的正是家鄉那條山路：哪段有蠱師出沒、哪處關卡收黑錢，她比誰都清楚。她淡淡插了一句，指了條更穩妥的岔道。商旅千恩萬謝，塞來一小袋銀錢。離座時，她在桌角留下一枚小小的銀鈴——苗疆人傳遞「我聽到了」的信物，願某個聽得懂的人收下。",
						},
					},
					{
						"id": "yamen_recognized",
						"label": "官差進門，攤開一張畫影圖形",
						"kind_hint": "mixed",
						"requires": {"event_flag": "yamen_grudge"},
						"next": "node_yamen",
					},
					{
						"id": "backer_ambush",
						"label": "幾個打手堵住了門",
						"kind_hint": "battle",
						"requires": {"event_flag": "thief_backer_grudge"},
						"outcome": {
							"kind": "battle",
							"battle": {
								"enemy_id": "thug",
								...
								"victory_effects": [
									{"kind": "gold", "amount": 20},
									{"kind": "set_flag", "flag": "thief_backer_grudge", "value": false},
								],
								"defeat_effects": [
									{"kind": "gold", "amount": -15},
									{"kind": "damage", "amount": 6},
							...
							"log": "門口的光忽然暗了——幾條大漢橫身堵住去路，為首的冷笑：「打了我家少爺，還想在這地面上安生喝酒？」是你先前種下的因，如今循著味找上門來了。你放下碗，慢慢站起身。",
						},
					},
					{
						"id": "buy_rumor",
			...
			"nodes": {
				"node_yamen": {
					"prompt": "官差把畫影圖形往桌上一拍——紙上那張臉，正是你。「那日仗著一身橫氣壓公門辦差的，就是你吧。」他身後兩名差役按著水火棍，堵死了門。這是你先前種下的因，躲不掉，只看你怎麼收。",
					"choices": [
						{
							"id": "pay_fine",
							"label": "認下，繳清罰金了結",
							"kind_hint": "mixed",
							"requires": {"min_gold": 25},
							"outcome": {
								"kind": "mixed",
								"effects": [
									{"kind": "gold", "amount": -25},
									{"kind": "set_flag", "flag": "yamen_grudge", "value": false},
								],
								"log": "你把銀錢一五一十數在桌上。官差收了罰金，當面撕了那張畫影圖形：「公門的帳，兩清了。」你望著他離去的背影，把這口悶氣嚥下去——當日逞的那點威風，原來是要連本帶利還的。",
							},
						},
						{
							"id": "fight_out",
							...
							"outcome": {
								...
								"log": "你掀翻桌子，碗筷四濺。差役掄棍撲上——這頓打，追根究柢，是你自己先前結下的因。把這一場了結，這筆帳才算翻篇。",
							},
						},
					],
				},
	...
	"sword_tomb": {
		...
		"outcomes": {
			...
			"gain_card": "你在冢前靜立半日，未曾伸手。暮色四合時，一柄斷劍的嗡鳴忽然轉柔，自行傾向你的方向——是劍冢認可了你的誠意，許你承接。你雙手捧劍起身，一套陌生的招式輪廓隨之流入記憶。這不是取，是託付。"
		},
		"tree": {
			"root": {
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "靈兒不懂劍，卻聽得見劍裡的人。她伸出雙手，讓靈力像水一樣漫過整片枯草——千百道守望的意志輕輕一顫，浮出劍身，與她的靈氣相觸。「你們守望的地方，我替你們看過了，很好。」嗡鳴漸漸靜下來，像一群終於肯闔眼的人。那份卸下重擔的鬆，也悄悄落在她與同伴身上。",
						},
					},
					{
						"id": "anu_shaman_rite",
						"label": "（阿奴）以巫祝之禮祭拜滿冢英靈",
						"kind_hint": "reward",
						"requires": {"character": ["anu"]},
						"outcome": {
							"kind": "reward",
							...
							"log": "阿奴不懂中原的劍，但苗疆的巫女懂得怎麼敬守護者。她折草為香，以指尖一滴血點在最老的那柄斷劍上，低聲唱起送靈的苗謠。歌聲裡，滿冢刀氣柔了下來，與她蠱袋中「守護之蠱」的氣息遙遙相應——原來天下的守護，本是同一種東西。",
						},
					},
					{
						"id": "leave",
					...
					"choices": [
						{
							...
							"outcome": {
								...
								"log": "你不退反進，以自己最擅長的方式迎上那道劍影——劍也好，蠱也好，仙術也好。劍靈似乎笑了：它試的本就是這一步的膽識，而非你手中的兵刃。冢中千百柄斷劍同時嗡鳴，為這一場試煉作證。",
							},
						},
						{
					...
					"choices": [
						{
							...
							"outcome": {
								...
								"log": "你雙手捧起那柄「未竟」之劍，輕聲應了一句：「我替你走。」劍身一震，像是卸下了百年的重，把畢生的心得與那未竟的執念，盡數托付給了你。從今往後，你出的每一招裡，都多了一個人的份量。",
							},
						},
						{
							"id": "lin_inherit",
				...
				"choices": [
					{
						...
						"label": "伸出手腕，請他診那道舊傷",
						"kind_hint": "reward",
						"requires": {"not_event_flag": "healer_grudge"},
						"outcome": {
							"kind": "reward",
					...
					},
					{
						...
						"label": "求他下針，挑掉一道礙根的招",
						"kind_hint": "reward",
						"requires": {"min_deck_size": 7, "not_event_flag": "healer_grudge"},
						"outcome": {
							"kind": "reward",
							"effects": [
								{"kind": "lose_card", "mode": "random"},
					...
					},
					{
						...
						"label": "藥廬的門簾放了下來",
						"kind_hint": "mixed",
						"requires": {"event_flag": "healer_grudge", "min_gold": 10, "has_potion_slot": true},
						"outcome": {
							"kind": "mixed",
							"effects": [
								{"kind": "gold", "amount": -10},
							...
							"log": "你才掀簾，老藥師頭也不抬，先把診脈的小凳收了回去。「藥，照價賣。手，不診。」他認得你——上回在他藥架上不告而取的，就是這雙手。你把銅錢放在桌角，接過藥瓶退出來，門簾在身後無聲放下。自作自受，怨不得人。",
						},
					},
					{
						"id": "inspect_shelves",
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "靈兒走上前，輕聲說：「你的方向是對的，我看著你。」少年木劍一抖，臉紅到耳根，握柄的手卻穩了下來。她在道旁石上坐定，就這麼看著他一劍一劍地劈——被人這樣認真地相信著，少年的每一劍都比方才更沉。看著那股不肯停的傻勁，她自己心口那點連日的倦，竟也悄悄散了。",
						},
					},
					{
						"id": "anu_footwork",
						"label": "（阿奴）教他下盤身法，以飛刀示範準頭",
						"kind_hint": "reward",
						"requires": {"character": ["anu"]},
						"outcome": {
							"kind": "reward",
							...
							"log": "「劍我不懂。」阿奴說得直接，「但你下盤浮，跑三步就喘。」她示範了一趟苗疆獵手的樁步，又反腕甩出一柄飛刀，釘進十步外樹幹上指甲大的節疤——「準頭，是腳給的。」少年張大了嘴，當場蹲起馬步。看他練得滿頭大汗，她想起苗疆學蠱的孩子，也是這樣一遍一遍不肯停。",
						},
					},
					{
						"id": "fix_form",
					...
					},
					{
						...
						"outcome": {
							...
							"log": "你退到樹蔭裡，靜靜看了一炷香。少年呼吸越來越短，腕力一抖一抖，可每一劍落下的那道弧線卻穩得分毫不差——這不是天分，是把同一個動作練到刻進骨頭裡的笨功夫。你心頭一震：劍仙從不問師承，只問你肯不肯死磕。看著看著，自己手上的功夫也沉了下來。",
						},
					},
					{
						"id": "lin_teach",
					...
					},
					{
						...
						"outcome": {
							...
							"log": "日頭落了又升，少年的木劍揮到指縫滲血，你把自家的功夫也走到虎口開裂。少年牙關咬得發白，你也咬到發白——誰都不肯先停手。晨光鋪上山道時，兩人喉頭一甜，各自嘔了口血，那股不肯服輸的狠勁卻在這一夜裡，硬生生刻進了骨頭。他撐著膝蓋朝你拜了三拜：「大俠，我懂了。」你扶著樹幹，半晌才直起腰。",
						},
					},
					{
						"id": "leave",
	...
	"drunk_swordsman": {
		...
		"character_flavors": {
			...
			"zhao_linger": "靈兒蹲下來，湊近了些。道士半睜開一隻眼，打量了她片刻，忽然怔住——那隻醉眼裡閃過一絲極快的清明。「仙靈島的氣味……」他喃喃了一句，聲音輕得像夢話，翻了個身又睡了過去。靈兒愣在原地。這個地名，她從未對任何人提起。她望著那個鼾聲漸起的邋遢道士，第一次覺得，這一路遇見的人，也許都不是偶然。",
		...
		"tree": {
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "靈兒不碰那葫蘆，只蹲下身，輕輕問出那個她從未對人提起的地名。道士的鼾聲停了。他半睜開眼，醉意褪去一線：「島上的水氣，隔十丈都認得。」他沒有多說，只抬起兩指，在她眉心虛虛一點——一縷溫潤的氣自眉心沉入丹田，像有人替她把散亂的靈氣輕輕攏了攏。「替我向島上的故人，問聲好。」說完翻身又睡，鼾聲如舊。",
						},
					},
					{
						"id": "offer_tea",
					...
					},
					{
						...
						"outcome": {
							...
							"log": "你不發一語，緩緩將滿身鋒銳之意凝於指尖。一直裝醉的道士眼皮忽然一掀，那點朦朧渾濁瞬間褪盡，露出深不見底的清明：「唔，有點意思。」他懶洋洋地伸出兩指，在你兵刃上「叮、叮、叮」彈了三下——輕得像撥弄琴弦，可你連日苦練都沒察覺的三處破綻，竟應聲消散。指尖收回時，他又闔上眼打起鼾，彷彿方才那一瞬從未存在。",
						},
					},
					{
						"id": "leave",
			...
			"nodes": {
				"node_drink": {
					"prompt": "葫蘆一傾，那酒像一條燒紅的鐵線直墜喉底，五臟六腑霎時燃了起來，你嗆得眼淚奪眶。道士聞聲半睜開眼，像撿了個寶似的笑開：「好個不要命的！你骨子裡這口銳氣是塊好料，可以煉——但要煉它，你得先學會醉。醉了，手上的功夫才活。」",
					"choices": [
						{
							"id": "drink_more",
							"label": "抹掉嘴角的血，再灌一口",
	...
	"yangzhou_officer": {
		"title": "蘇州府緝盜",
		"flavor": "蘇州城內人聲鼎沸，一個蒙面黑影與你擦身而過，一個沉甸甸的包袱掉在你腳邊。此時官差已在後方大喊：「站住！」",
		"character_flavors": {
		...
		"tree": {
			"root": {
				"prompt": "蘇州街市叫賣聲震天，魚腥混著脂粉氣撲鼻。一個蒙面黑影貼著你肩膀竄過，「咚」地一聲，沉甸甸的包袱落在你腳邊。後頭一個年輕官差紅著臉追來，扯著嗓子喊：「站住——別動那包袱！」他眼裡比起捉賊，更像是怕回去沒法向府衙交差。你只剩一個呼吸的工夫。",
				"choices": [
					{
						"id": "snatch_and_run",
						"label": "抄起包袱，撒腿就鑽巷子",
					...
					},
					{
						...
						"label": "低頭裝沒看見，徑直走過",
						"kind_hint": "neutral",
						"outcome": {"kind": "neutral", "effects": [], "log": "你低頭快步穿過人群，腳尖差點絆上那包袱也沒回頭。年輕官差從你身旁急掠而過，呼喝聲很快被市聲淹沒——蘇州城的麻煩，多得很，犯不著沾上一樁。"},
					},
				],
			},
			"nodes": {
					...
					"choices": [
						...
						},
						{
							...
							"outcome": {
								...
								"log": "你縱身躍上屋瓦。蘇州捕頭也不甘示弱，腳尖一點跟著上來——這場追逐要在屋頂結束。",
							},
						},
					],
				},
					...
					"choices": [
						{
							...
							"outcome": {
								...
								"log": "你縱身一躍，落在他的去路。扭打間包袱散開，滾出半錠烙著官印的官銀——血是護銀鏢師的。這人不是尋常扒手，是劫官餉的亡命之徒，反手已拔出一柄短匕。",
							},
						},
						{
							"id": "let_him_go",
							...
							"outcome": {
								...
								"log": "你停下腳步，朝他點了點頭。他怔住，隔著巷影啞聲丟下一句：「銀子是贓官的，血是他家看門狗的。」說罷翻牆而去。這次的放，是賭他下次的還。",
							},
						},
					],
				},
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "月如按劍立在蓮池畔，閉上眼。林家堡教她「靜中求銳」，可堡裡人聲、江湖風霜，從沒讓她真正靜下來過——直到此刻，水月宮的靈氣漫過腳踝，劍心忽然澄明如鏡。再睜眼時，她手裡那道始終差半分火候的招式，已利落得連自己都吃了一驚。她朝女媧神像頷首一禮：這份靜，她記下了。",
						},
					},
					{
						"id": "read_steles",
	...
	"flower_spirit": {
		...
		"character_flavors": {
			...
			"zhao_linger": "靈兒在花香裡站定，沒有捂鼻，也沒有後退。她看得比誰都清楚——那女子不是人，一如她自己也不全是。花瓣底下那雙眼睛空得發慌，靈兒心頭一軟：同是非人之身，一個被憐愛著長大，一個卻被什麼逼到了這一步。她輕聲開口，像對一個迷路的孩子：「姊姊，妳……不想這樣的，對不對？」",
			"lin_yueru": "月如的手在花香飄來的瞬間就按上了劍柄。好看？她只看見那女子每一步都踩在最利於出手的方位，笑意溫柔，殺意卻藏得極深——這是老練的妖，慣會用皮相取人性命。林家堡的規矩她記得清楚：邪不容赦。可那雙空茫的眼，又讓她的劍遲了半分。",
			"anu": "阿奴皺起鼻子，一下就把那股甜香拆穿了——這不是花香，是蠱香！和苗疆花蠱的路數同源，只是煉法更陰。她袖裡的蠱早已醒了，貼著手腕輕輕爬。阿奴瞇眼打量霧裡那女子：能把花蠱煉進自己身體裡的，要嘛是瘋子，要嘛……是被人下了手。",
		},
		...
		"tree": {
			...
			"nodes": {
					...
					"choices": [
						{
							...
							"outcome": {
								...
								"log": "你毫不遲疑出手——花香依舊在腦中糾纏，但你此刻的心志，比花香更純。",
							},
						},
						{
							"id": "seal_censer",
				...
				"node_pity": {
					"prompt": "你迎著花香看進她眼底，那點空虛的飢渴底下，竟有一絲不甘——殺意不像出於本意，倒像有個更深、更冷的東西藏在她身後，借她的手取人性命。你認得那股藏在花香底下的陰冷：月夜祭壇上才有的邪息，拜月教馭妖的手筆。她曾經，多半也只是個會在山道採花的普通女子。她的唇動了動，沒出聲，像在求你，又像在求自己別動手。",
					"choices": [
						{
							"id": "purify_qi",
							"label": "不拔劍，渡她一縷清淨靈氣",
						...
						},
						{
							...
							"outcome": {
								...
								"log": "她沒有抵抗，只是看著你抬起手。你深吸一口氣——『願妳下一世，不再如此。』",
							},
						},
					],
				},
	...
	# ── PAL1 名場面（角色情感深度互動） ─────────────────────────────────
	# 自創內容（非 PAL1 正史）：劍中女子劍靈為本專案原創角色，貫穿 shrine /
	# ghost_forest（lxy_sword_guide）/ 本事件，設定為李逍遙佩劍之靈。
	# 刻意與《仙劍三》龍葵區隔：無兄妹、無前世、無鑄劍殉身設定，僅取「劍靈有情」語感。
	"jianling_whisper": {
		"title": "劍靈低語",
				...
				"choices": [
					{
						...
						"outcome": {
							"kind": "reward",
							"effects": [{"kind": "permanent_power", "amount": 2}],
							"log": "那縷紅光緩緩浮出劍鞘，化作一道細細的光圈，繞著你的右手轉了一圈，溫溫地，像有人替你理了理袖口。一道清亮的劍意順勢沉入腕底。她始終沒說再見，臨了只又閃了一下——那一閃彷彿在說：別怕，我還在，我一直都在。",
						},
					},
					{
						"id": "sword_dialogue",
						"label": "拔劍出鞘，以劍意與她應和",
						"kind_hint": "reward",
						"requires": {"character": ["li_xiaoyao", "lin_yueru"], "deck_archetype": ["attack"]},
						"outcome": {
							"kind": "reward",
							"effects": [
								{"kind": "gain_card_pool", "pool": "character"},
					...
					},
					{
						...
						"outcome": {
							...
							"log": "靈兒蹲下身，指尖輕輕貼上劍身：「你好，我是靈兒。我能感受到你。」紅光定了定，像沒料到自己被認出來。靈兒不催，只把一縷溫軟的靈力渡過去，像遞出一隻手。兩個非人的存在就這樣靜靜相繫了片刻——臨了，紅光把一縷純淨的劍氣化作靈兒能用的靈息，輕輕還進她掌心，算是回禮。",
						},
					},
					{
						"id": "anu_company",
						"label": "（阿奴）鬆開蠱袋，安靜陪這個靈等一會兒",
						"kind_hint": "reward",
						"requires": {"character": ["anu"]},
						"outcome": {
							"kind": "reward",
							...
							"log": "阿奴本能地按住蠱袋，又慢慢鬆開了——這個靈沒有惡意，只是在等一個人。苗疆人最懂等待：獵人等獸徑，蠱師等蠱熟。她盤腿坐下，陪那縷紅光一起望著夜路，一句話也沒問。臨走時，紅光繞著她袖口的飛刀輕輕轉了一圈，替刀鋒添了一絲說不出的銳——像是謝她，懂得不打擾。",
						},
					},
					{
						"id": "lxy_apology",
	...
	"aqi_reunion": {
		...
		"character_flavors": {
			...
			"zhao_linger": "靈兒聽見笛聲，本能地放慢了腳步。那聲音很乾淨，沒有惡意，卻有一種強烈的『在喚人回家』的意思——她聽得出來，這不是吹給過路人聽的曲子。少年看見她，輕輕點了個頭，把那一段吹完才放下笛子。靈兒忽然有些羨慕：被這樣一支笛子等著的人，無論走多遠，都是有家可回的。",
	...
	"tangyu_sparring": {
		...
		"character_flavors": {
			...
			"anu": "阿奴看見那個揮劍的身影，腳步一下子釘在原地。那個握劍的姿勢，那股怎麼摔都會爬起來的倔勁——「小虎哥？」少年聞聲回頭，手裡的劍差點脫手：「阿奴？！」兩人隔著半條山道對望，誰都沒先動。最後還是他先笑了，抹了把汗跑過來，像小時候在大理城外那樣，獻寶似的把劍舉給她看：「我在練劍！練好了……練好了就去找妳。」阿奴低頭看著劍身上映出的自己，輕聲說：「笨蛋。我這不是來了。」",
		},
				...
				"choices": [
					{
						...
						"outcome": {
							...
							"log": "三十招打下來，少年劍劍露怯卻劍劍不退，被你震得虎口發麻仍咬牙再上。他那份毫無雜質的鬥志，竟燒得你血脈也跟著滾燙。收招時，你怔了一怔——丹田裡，竟尋回了幾分當年剛入門時、那種天不怕地不怕的銳氣。「好小子。」你笑著拍了拍他的頭。",
						},
					},
					{
						"id": "correct_form",
					...
					{
						"id": "zhao_gentle_guide",
						"label": "（趙靈兒）柔聲提點：劍不是用力握的，是用心扶的",
						"kind_hint": "reward",
						"requires": {"character": ["zhao_linger"]},
						"outcome": {
							"kind": "reward",
							...
							"log": "靈兒不懂劍招，卻看得懂那雙緊繃到發白的手。她走近，柔聲說：「你的姿勢要再放鬆一點。劍不是用力握的，是用心扶的。」少年怔了怔，依言鬆開半分——那柄沉重的青釭劍，忽然就聽話了。他睜大眼睛，看看劍，又看看她。靈兒笑了。這句話說出口，她自己心裡某道一直繃著的弦，也跟著輕輕鬆開。",
						},
					},
					{
						"id": "anu_childhood",
						"label": "（阿奴）像小時候那樣，陪他練到日頭偏西",
						"kind_hint": "reward",
						"requires": {"character": ["anu"]},
						"outcome": {
							"kind": "reward",
							...
							"log": "阿奴撿了三枚石子，反手三道飛刀，把石子一顆顆釘上石壁，給他當靶心：「劍尖照著釘印走，準頭是這樣練的。」少年瞪圓了眼：「妳什麼時候練的這手？！」「你走了以後。」她說得輕描淡寫。兩人就這樣一個練劍、一個擲刀，像小時候在大理城外那樣，比到日頭偏西誰也不肯先停。收手時，阿奴望著他汗透的背影，忽然覺得——原來家不是一個地方，是有人肯陪你笨笨地練到天黑。",
						},
					},
					{
						"id": "observe_sword",
					...
					},
					{
						...
						"outcome": {
							...
							"log": "你收起那點居高臨下，鄭重地擺開架勢相迎。少年的劍稚嫩漏洞百出，可正因你不肯敷衍，反倒被逼著把自己的招意一層層攤開、一處處重審——原來教人，從來都是在磨自己。一場酣暢淋漓的過招下來，你那道纏了多時、始終不通的招式，竟在汗水裡豁然開竅。",
						},
					},
					{
						"id": "take_his_sword",
				...
				"choices": [
					{
						...
						"label": "縱身躍上擂台，接她這一問",
						"kind_hint": "battle",
						# 月如本人是擂主，不能自己挑戰自己——她走 lyr_on_stage 分支
						"requires": {"character": ["li_xiaoyao", "zhao_linger", "anu"]},
						"next": "node_duel",
					},
					{
						"id": "watch_learn",
						"label": "擠在台下，把她的劍看個分明",
						"kind_hint": "reward",
						"requires": {"character": ["li_xiaoyao", "zhao_linger", "anu"], "observe_token": true},
						"outcome": {
							"kind": "reward",
							"effects": [
								{"kind": "power", "amount": 1},
					...
					{
						"id": "lyr_watch_below",
						"label": "（林月如）立在台側，把挑戰者的路數看個分明",
						"kind_hint": "reward",
						"requires": {"character": ["lin_yueru"], "observe_token": true},
						"outcome": {
							"kind": "reward",
							"effects": [
								{"kind": "power", "amount": 1},
							...
							"log": "月如按劍立在台側，一場一場看下去。庸手是庸手，可看盡天下庸手，也是一種修行——江湖野路子千奇百怪，其中一記怪異的側身卸勁，竟讓她眼前一亮。她在心裡把那一式拆開、掰直、收進林家劍法的骨架裡。爹說招親是為她好；她想，今日的收穫，倒真不算白站這一天。",
						},
					},
					{
						"id": "lxy_stumble",
					...
					},
					{
						...
						"label": "湊個熱鬧，看罷便走",
						"kind_hint": "neutral",
						"outcome": {"kind": "neutral", "effects": [], "log": "你夾在人潮裡看了一陣，台上紅衣翻飛、劍光凜凜，惹得滿街喝采。有人擠破頭想上台，有人抱著頭滾下來。你笑了笑，擠出人群繼續趕路，鑼鼓聲在身後漸遠。"},
					},
				],
			},
			"nodes": {
					...
					"choices": [
						{
							...
							"outcome": {
								"kind": "battle",
								"battle": {
									# 無月如專屬敵人，以「試煉劍靈」抽象化她的擂台劍勢
									# （名稱貼近切磋試劍的意象）；hp_mult 壓低作點到為止的較量
									"enemy_id": "trial_swordshade",
									"enemy_hp_mult": 0.75,
									"victory_effects": [
										{"kind": "gain_card_pool", "pool": "rare"},
								...
								"log": "她的劍又快又烈，招招不留情面，逼得你連連硬接，火星四濺。你索性提起全副本事相迎——這姑娘最瞧不起的便是敷衍，要贏她，唯有以真本事見真章。台下喝采如雷，她唇角竟揚起一抹久違的笑：「好！這才有點意思！」",
							},
						},
						{
							"id": "yield_gracefully",
							...
							"outcome": {
								...
								"log": "鬥到酣處，你忽然撤步收勢，抱拳一揖：「姑娘劍法高明，在下甘拜下風。」她劍尖頓在半空，一時竟有些怔——分明還能再打，你卻給足了她顏面。她哼了一聲別過臉去，耳根卻悄悄紅了，眼底那分睥睨化作了實打實的認可。一場切磋，劍上、心裡，兩個人都有所得。",
							},
						},
					],
				},
				...
				"choices": [
					...
					},
					{
						...
						"outcome": {
							...
							"log": "你按上書生冰涼的手腕，渡出一縷真氣護住他將熄的心脈。你自己虛了幾分，眼角餘光卻瞥見那女子望著你，眼裡有種旁人讀不懂的瞭然。那一刻你忽然懂了她——有些力量，正是在毫無保留地給出去之後，才真正變得強大。她默默替你也盛了一小盞剛煎好的仙釀，遞到你手裡：「這一盞，謝你。」",
						},
					},
					{
						"id": "observe_truth",
	...
	# 自創內容（非 PAL1 正史）：婉兒為原創人物，PAL1 無此角色。
	# 依 CLAUDE.md「PAL1 素材不足才自創」原則：以正史的拜月教暴行（CANON §拜月教）
	# 為錨，具象化其對無名百姓的傷害，補足「反派之惡有受害者面孔」的敘事缺口。
	"jiang_waner_grief": {
		"title": "婉兒之死",
