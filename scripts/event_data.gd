...
const VARIANTS: Dictionary = {
	...
	"shilipo_sword_god": {
		"title": "十里坡劍神",
		"flavor": "在一片被謔稱為「十里坡」的山坡上，一名少年正不厭其煩地對著空氣揮舞木劍。他的身形雖顯稚嫩，意氣卻出奇地專注。「只要練上一萬次，就算是蜂王也打得倒！」他擦了擦汗，向你請教劍術的關隘。",
		"heal": 0, "gain_cost": 0, "power": 2, "power_label": "共鳴",
		"choices": ["upgrade", "power", "remove"],
		"outcomes": {
			"upgrade": "你指點了少年的木劍姿勢。見你如此傾囊相授，少年的純真劍意反倒啟發了你——手中的某個招式瑕疵盡除。",
			"power": "你與少年一同切磋。木劍相交的清脆聲中，那股對劍道最純粹的執著感染了你，體內氣息更添英銳之氣。",
			"remove": "少年看著你的劍招，天真地問：「大俠，你這招是不是有點多餘？」一語驚醒夢中人。你靜心內省，斬斷了招式中累贅的旁枝末節。"
		}
	},
	"drunk_swordsman": {
		"title": "醉臥劍仙",
		...
		"outcomes": {
			"tainted_power": "你搶過 his 葫蘆灌了一口，喉嚨如烈火灼燒！你忍不住劇烈咳嗽（損血），但一股狂亂難抑的酒意在體內橫衝直撞，出招更添三分狂氣。",
			"heal": "你退在一旁，看他醉語。清冽的酒香混著松針味，竟讓你的心跳平復，體內的隱疾在平穩的呼吸中有些許好轉。",
			"gain_card": "你趁他半醉，遞給他一壺清茶。他砸砸嘴，醉醺醺地吐出幾句玄妙無比的口訣，一道新招式悄然在你心頭成型，但你為此熬神耗思，氣血翻湧。"
		}
	},
	"yinlong_cave": {
		"title": "隱龍窟幽怨",
		"flavor": "陰森的洞窟深處，隱約傳來女子幽怨的低泣。你走近一看，一名狐面半人身的少女正縮在角落，瑟瑟發抖。她懇求你不要傷害她的族民，並願意獻出洞中的寶物換取生路。",
		"heal": 12, "gain_cost": 6, "pact_max_hp_cost": 6, "pact_power": 3, "power_label": "奪丹",
		"choices": ["heal", "pact", "gain_card"],
		"outcomes": {
			"heal": "你收起武器，示意她離去。她感激地向你行禮，臨走前留下一縷溫和的療癒妖光，撫平了你身上的傷痛。",
			"pact": "你要求她獻出靈魂本源。她咬牙點頭，一縷冰冷徹骨的妖丹元神融入你的胸口。你感到生機被永遠剝奪了一部分，但妖法帶來的破壞力卻讓招式更加致命。",
			"gain_card": "你冷酷地逼問寶藏下落。她驚恐地拋出一卷古老的地底殘卷，隨即化作煙霧遁走。為了破解殘卷上的妖族心法，你付出了不少心神與氣血。"
		}
	},
	"yangzhou_officer": {
		"title": "揚州府緝盜",
		"flavor": "揚州城內人聲鼎沸，一名身穿捕快官服的女子正滿街追捕女盜。突然，一個蒙面黑影與你擦身而過，一個沉甸甸的包袱掉在你腳邊。此時官差已在後方大喊：「站住！」",
		"heal": 0, "gain_cost": 0, "power": 2, "power_label": "分贓", "gamble_win_power": 4, "gamble_lose_damage": 8,
		"choices": ["gamble", "upgrade", "remove"],
		"outcomes": {
			"gamble_win": "你悄悄收起包袱，將官差引向別處。事後打開包袱，裡面除了一些療傷靈藥，還有一卷極其珍貴的戰鬥身法，你功力大增。",
			"gamble_lose": "你正要收起包袱，卻被追上的官差人贓並獲！一陣混亂的衝突中，你被官差一棍重重擊中，狼狽逃脫，包袱也在混亂中被沒收。",
			"upgrade": "你高喊一聲，順手指明女盜的逃跑方向。捕快向你抱拳致謝，並給予你短暫的武學指點，讓你的招式更為熟練洗鍊。",
			"remove": "你一腳將包袱踢開，雙手一攤撇清關係。看著那包袱上沾染的血跡與因貪念差點引火上身的凶兆，你頓時心境空靈，拂去了一身雜念。"
		}
	},
	"lingmiao": {
		"title": "靈廟顯靈",
		"flavor": "路旁矗立著一座飽經風霜的古靈廟。廟堂正中，一盞油燈的火焰無風自動，在幽暗中散發出柔和的金光。傳說此廟能以靈符超渡亡魂、喚回生機——倒下的同伴或許還有救。",
		"heal": 16, "gain_cost": 0, "power": 0, "power_label": "求力",
		"revive_amount": 30,
		"choices": ["revive", "heal", "upgrade"],
		"outcomes": {
			"revive": "你恭敬地在廟前上香叩頭。那盞油燈的火光突然大盛，化作一道暖流穿透虛空——倒下的同伴在金光中緩緩睜開雙眼，生機已然回返。",
			"heal": "你在廟前靜坐調息。靈廟的古意與香火在你周身流轉，積累的傷勢在不知不覺間悄然癒合。",
			"upgrade": "廟牆上刻有先人留下的武學銘文，辭藻古奧難辨。你凝神反覆推敲，終於在某處豁然貫通，一門招式因此更加精進。"
		}
	},
	"xianling_shrine": {
		"title": "仙靈島水月宮",
		"flavor": "穿過桃花瘴，一座縹緲的宮殿坐落在蓮花池中央。池畔置有一尊女媧神像，四周白蓮盛開，靈氣升騰。這裡充滿了令人懷念的溫柔回憶，讓你的心境在此刻無比澄明。",
		"heal": 20, "gain_cost": 0, "power": 0, "power_label": "悟道",
		"choices": ["heal", "upgrade", "view_deck"],
		"outcomes": {
			"heal": "你掬起一捧溫潤的蓮池仙水服下，仙氣滌盪全身，長久累積的內傷與疲憊一掃而空。",
			"upgrade": "神像旁的石壁上刻著若隱若現的《仙風雲體術》殘篇。你駐足靜思，一門困擾你許久的招式在此刻豁然開朗，臻至完美之境。"
		}
	}
}
