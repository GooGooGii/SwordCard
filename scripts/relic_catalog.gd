...
static func _make(id: String, name: String, desc: String, rarity: String, triggers: Array[Dictionary], color: Color = ThemeColors.BORDER_GOLD, shape: String = "diamond") -> RelicData:
...
static func _generals() -> Array[RelicData]:
	...
	l.append(_make("feng_hun_yu", "風魂玉", "本場戰鬥傷害 +1。", "rare",
		[{"trigger": "battle_start", "effects": [{"kind": "self_power", "amount": 1}]}], ThemeColors.HIGHLIGHT_GOLD))
	...
	l.append(_make("zhi_fu_xiang", "紙符箱", "每回合開始額外抽 1 張牌。", "rare",
		[{"trigger": "turn_start", "effects": [{"kind": "self_draw", "amount": 1}]}], ThemeColors.HIGHLIGHT_GOLD))
	...
	l.append(_make("e_yun_fu", "厄運符", "每回合開始敵人 +1 層虛弱。", "uncommon",
		[{"trigger": "turn_start", "effects": [{"kind": "enemy_weak", "amount": 1}]}], ThemeColors.HP_FILL))
	...
	l.append(_make("nu_mu_zhu", "怒目珠", "每次獲得護體，敵人 +1 層破綻。", "uncommon",
		[{"trigger": "card_played", "filter": {"effect_has": "block"}, "effects": [{"kind": "enemy_vulnerable", "amount": 1}]}], ThemeColors.HP_FILL))
	...
	l.append(_make("hu_fa_zhou", "護法咒", "戰鬥開始回復 4 生命，受到的傷害 -1。", "rare",
		...
		{"trigger": "passive_modifier", "effects": [{"kind": "damage_taken_reduction", "amount": 1}]}], ThemeColors.BORDER_GOLD))
	...
	l.append(_make("tong_bao_qian", "通寶錢", "商店每件商品 -8 銅錢。", "uncommon",
		[{"trigger": "permanent", "effects": [{"kind": "shop_discount", "amount": 8}]}], ThemeColors.BORDER_GOLD))
