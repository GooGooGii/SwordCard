...
# 任何地方都算打出。
const ENEMY_TARGETED_KINDS: Array[String] = ["damage", "damage_all", "poison", "poison_all", "weak", "weak_all", "vulnerable", "vulnerable_all", "consume_energy_damage", "consume_energy_damage_all", "poison_burst", "damage_debuff_bonus", "stun"]
