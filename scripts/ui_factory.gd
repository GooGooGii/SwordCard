...
static func main_menu_button(text: String, emphasized: bool = false, min_height: float = 58.0, font_size: int = 20) -> Button:
	...
	var base: Color = Color("ead8a8", 0.84) if emphasized else Color("f6f1e6", 0.74)
	var hover: Color = Color("f1dfb2", 0.94) if emphasized else Color("fbf7ef", 0.86)
	var pressed: Color = Color("d9c18e", 0.94) if emphasized else Color("ece3d4", 0.86)
	var border: Color = Color("efe3c1", 0.82) if emphasized else Color("f3eee4", 0.64)
	var font_color: Color = Color("3a2d1a") if emphasized else Color("31404c")
