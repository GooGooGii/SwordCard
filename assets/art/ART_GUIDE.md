...
## PAL1 原作圖先行（Mandatory Reference Gate）

任何角色、敵人、Boss、背景或劇情插圖在繪製／AI 生成前，必須先找到並實際查看 PAL1 遊戲畫面。優先採 DOS／95 版原圖；若像素圖不足以辨識細節，可補充官方《新仙劍奇俠傳》復刻版，但必須標示版本，不可把同人圖或泛用仙俠圖當成原作。

固定流程：

1. 找到至少一張能清楚辨識目標的原作／官方復刻遊戲圖，保存來源網址。
