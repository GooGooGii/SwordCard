...
> **執行狀態（2026-06-11）：15/15 全部完成。**
> P0-1 選單✅ P0-2 李逍遙✅ P1-3 字卡✅ P1-4 地圖✅ P1-5 卡面✅ P2-6 征途錄✅ P2-7 成就✅
> P2-8 調查後不需改✅ P2-9 banter✅ P2-10 組隊修正✅ P3-11 切人✅ P3-12 短征✅
> P3-13 盤點完成（12 張違和卡待美術重出，見 ART_TODO §14A）✅ P3-14 盤點後縮減✅
> P3-15 經濟壓測✅（agent 親玩 4 幕；**發現收入通膨**，修正建議見 `BALANCE_REPORT.md` §六——
> 屬下一個平衡批次的工作，非本計劃範圍）。
...
## P3-14 音訊收尾 ｜風格 — ✅ 盤點後縮減（2026-06-11）

- **轉檔不做**：實測 `assets/audio` 總量僅 **7.1MB**（BGM 每首 ~270KB 短 loop），「.wav 體積大」的前提錯誤，
  轉 .ogg 無意義。
- **BGM 風格抽聽**：留待人工（agent 無法聽音檔）。
- **背景 LUT 統一**：涉及對美術原檔的批次後製，與並行進行的美術工作流衝突，**留給美術側決定**，程式不代改。
