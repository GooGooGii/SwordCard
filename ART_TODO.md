...
## 十七、商店畫面美術（🔴 4 張待補，2026-07-09 商店美化審查）
...
| 檔名 | 用途 | 規格 | 建議意象 |
|---|---|---|---|
| `assets/art/shop_bg.png` | 山道商店背景（取代現借用的 `event_bg.png`） | 16:9 滿版、**不去背** | 山道旁行商小攤：布篷竹架、貨擔藥簍、掛著銅錢串與符袋，遠景青山古道，暖褐＋米黃水墨調（跟金色 UI 呼應） |
| `assets/art/shop_black_bg.png` | 夜路黑店背景 | 16:9 滿版、**不去背** | 夜色小屋簾幕半掩：一盞昏黃燈籠、簾後貨影幢幢，紫黑＋暗金調，神秘微危險感 |
| `assets/art/npc/shop_merchant.png` | 山道商店行商立繪 | 去背 RGBA、半身、主體居中 | 憨厚中年行商：斗笠布衫、肩搭汗巾、笑瞇瞇撥算盤，市井親切感（PAL1 貨郎風） |
| `assets/art/npc/shop_black_merchant.png` | 黑店老闆立繪 | 去背 RGBA、半身、主體居中 | 簾影中的乾瘦掌櫃：半張臉藏在陰影，指節細長捻著銅錢，皮笑肉不笑 |
