...
## 十八、戰鬥背景明度重生（🟢 已全部完成，2026-07-15 製作人裁決）
...
| 檔名 | 場景 | 明度目標 | 狀態 |
|---|---|---|---|
| `assets/art/battle_bg_act_1.png` | 餘杭/十里坡：晨光竹林山道＋小亭 | ☀ 亮（晨光田園、清爽有希望感） | 🟢 已完成 (2026-07-15 重製) |
| `assets/art/battle_bg_act_5.png` | 隱龍窟：晶光通明的靈氣洞窟（16:9） | ☀ 亮 | 🟢 已完成 (2026-07-15 重製) |
| `assets/art/battle_bg_act_7.png` | 苗疆：白日山寨、陽光瀑布、綠意彩旗 | ☀ 亮 | 🟢 已完成 (2026-07-15 重製) |
| `assets/art/main_menu_bg.png` | 主選單：同構圖改晨曦仙山 | ☀ 亮 | 🟢 已完成 (2026-07-15 重製) |
