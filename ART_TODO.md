...
### 🟢 遺物圖示更新（2026-06-11 新增）
- `xiaoyao_ling` (逍遙令) - 🟢 已完成專屬水墨圖

> 備註：其餘新舊遺物中，尚有 12 件遺物（攝魂蠱鈴/血棘冠/玄武重甲/狂戰護符/龜息玄甲/業火爐 以及 鎮魂鈴 等開場/免疫系列）目前採用程序化圖示（icon_color + icon_shape）作為 fallback 向量渲染，後續可依需求補齊專屬去背水墨圖檔。
